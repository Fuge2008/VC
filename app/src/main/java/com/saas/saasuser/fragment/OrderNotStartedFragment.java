...
public class OrderNotStartedFragment extends BaseFragment  implements NetIntentCallBackListener.INetIntentCallBack,AdapterView.OnItemClickListener, ListViewCompat.OnRefreshListener,ListViewCompat.OnLoadListener{
    ...
    protected View initView() {
        View view = View.inflate(mActivity, R.layout.fragment_order_not_started, null);
