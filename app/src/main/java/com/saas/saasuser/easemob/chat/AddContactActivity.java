...
public class AddContactActivity extends IMBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnSubmit.setText("查找");

		String strAdd = getResources().getString(R.string.add_friend);
		//mTextView.setText();
		Util.setHeadTitleMore(this, strAdd, true);
		...
		findViewById(R.id.head_more).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String saveText = btnSubmit.getText().toString();

				if (getString(R.string.button_search).equals(saveText)) {
					toAddUsername = name;
					if(TextUtils.isEmpty(name)) {
						new EaseAlertDialog(AddContactActivity.this, R.string.Please_enter_a_username).show();
						return;
					}
