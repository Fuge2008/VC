...
public class GroupDetailsActivity extends IMBaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Util.setHeadTitleMore(this, "群组名称", true);
		...
		((TextView) findViewById(R.id.head_title)).setText(group.getGroupName() + "(" + group.getMemberCount() + st);
						...
						public void run() {
							try {
								...
								runOnUiThread(new Runnable() {
									public void run() {
										((TextView) findViewById(R.id.head_title)).setText(group.getGroupName() + "(" + group.getMemberCount() + ")");
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.rl_change_group_name://编辑群名称
...
//						REQUEST_CODE_EDIT_GROUPNAME);
				break;
			case R.id.rl_change_group_description://编辑群描述
