package com.saas.saasuser.easemob;
...
import com.saas.saasuser.easemob.chat.ChatActivity;
import com.saas.saasuser.easemob.chat.VideoCallActivity;
import com.saas.saasuser.easemob.chat.VoiceCallActivity;
import com.saas.saasuser.easemob.db.DemoDBManager;
import com.saas.saasuser.easemob.db.InviteMessgeDao;
import com.saas.saasuser.easemob.db.UserDao;
import com.saas.saasuser.easemob.domain.EmojiconExampleGroupData;
import com.saas.saasuser.easemob.domain.InviteMessage;
import com.saas.saasuser.easemob.domain.RobotUser;
import com.saas.saasuser.easemob.parse.UserProfileManager;
import com.saas.saasuser.easemob.receiver.CallReceiver;
import com.saas.saasuser.easemob.video.util.PreferenceManager;
...
//                appContext.startActivity(conferenceIntent);
                Toast.makeText(appContext,"暂时不能进入多人视频",Toast.LENGTH_SHORT).show();
            }
        });
