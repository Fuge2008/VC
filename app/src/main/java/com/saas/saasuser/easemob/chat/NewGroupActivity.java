...
public class NewGroupActivity extends IMBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Util.setHeadTitleMore(this, "创建群组", true);
		...
		publibCheckBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
		    ...
		    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		        if(isChecked){
		            secondTextView.setText("加群需要群主同意");
		        }else{
                    secondTextView.setText("开放成员邀请");
		        }
		    }
		});
		findViewById(R.id.head_more).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(name)) {
					new EaseAlertDialog(NewGroupActivity.this, R.string.Group_name_cannot_be_empty).show();
				} else {
