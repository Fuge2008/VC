 ...
 * 带左滑删除的listview
 */
public class ListViewOrderTotal extends ListView  implements OnScrollListener{

    private static final String TAG = "ListViewCompat";

    private OrderTotalSlideView mFocusedItemView;
    // 区分当前操作是刷新还是加载
    ...
    public ListViewOrderTotal(Context context) {
        super(context);
        initView(context);
    }

    public ListViewOrderTotal(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public ListViewOrderTotal(Context context, AttributeSet attrs, int defStyle) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (position != INVALID_POSITION) {
                    OrderTotalItem data = ( OrderTotalItem) getItemAtPosition(position);
    ...
    public void onRefreshComplete() {
        String currentTime = TimeUtils.getNowTime();
