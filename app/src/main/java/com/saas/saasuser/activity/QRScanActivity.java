...
import com.saas.saasuser.view.zxing.core.QRCodeView;
import com.saas.saasuser.view.zxing.zx.QRCodeDecoder;
import com.saas.saasuser.view.zxing.zx.ZXingView;
...
//							netIntent.client_getUserByPhone(phone1, new NetIntentCallBackListener(QRScanActivity.this));
	...
	public void updateView() {
		...
		startActivity(new Intent(QRScanActivity.this, ProfileActivity.class).putExtra("phone", phone));
