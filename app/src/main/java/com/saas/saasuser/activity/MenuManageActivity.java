...
import com.saas.saasuser.view.addViews.adapter.MenuParentAdapter;
import com.saas.saasuser.view.addViews.adapter.MyAdapter;
import com.saas.saasuser.view.addViews.drag.DragCallback;
import com.saas.saasuser.view.addViews.drag.DragForScrollView;
import com.saas.saasuser.view.addViews.drag.DragGridView;
...
public class MenuManageActivity extends BaseActivity {
	...
	private void initView() {
		// TODO Auto-generated method stub
		ll_top_back = (LinearLayout) findViewById(R.id.head_back);
		ll_top_sure = (LinearLayout) findViewById(R.id.head_more);
		tv_top_title = (TextView) findViewById(R.id.head_title);
		tv_top_sure = (TextView) findViewById(R.id.btn_submit);
	...
	public void initUrl(MenuEntity cateModel) {
		...
		if (tv_top_sure.getText().toString().equals("管理")) {
			...
			if (StringUtils.equals("VV通信", title)) {
				startActivity(new Intent(MenuManageActivity.this, IMMainActivity.class));
			} else if (StringUtils.equals("个人中心", title)) {
				startActivity(new Intent(MenuManageActivity.this, ProfileActivity.class));
				// startActivity(new Intent(MenuManageActivity.this, RegularInvoiceActivity.class));
			} else if (StringUtils.equals("企业发票", title)) {
				startActivity(new Intent(MenuManageActivity.this, CorporateInvoiceActivity.class));
			} else if (StringUtils.equals("企业名片", title)) {
				startActivity(new Intent(MenuManageActivity.this, EnterprisesCardActivity.class));
			} else if (StringUtils.equals("新增订单", title)) {
				startActivity(new Intent(MenuManageActivity.this, NewOrdersActivity2.class));
			} else if (StringUtils.equals("租行申请", title)) {
				startActivity(new Intent(MenuManageActivity.this, AddTripApplyActivity.class).putExtra("reBuiltOrder", "0").putExtra("orderId", ""));
			} else {
				ToastUtils.showShortToast(MenuManageActivity.this, "当前功能尚未上线，敬请关注！");
			}
		}
	}
