...
public class RegularInvoiceActivity extends BaseActivity implements NetIntentCallBackListener.INetIntentCallBack{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regular_invoice);
        ButterKnife.bind(this);
        MyApplication.getInstance().addActivity(this);
        util = new SharedPreferencesUtil(this);
        Util.setHeadTitleMore(this, "普通发票", true);
        getBitmap();
        initQR();


        new NetIntent().client_getCompanyVnvoice(util.getCompanyId(), new NetIntentCallBackListener(this));//  TODO  获取公司名片信息
        if (dialog == null) {
    ...
    private void getBitmap() {
        Glide.with(RegularInvoiceActivity.this).load(util.getPicture()).asBitmap().into(new SimpleTarget<Bitmap>() {
            @Override
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                if (bitmap == null) {
                    bitmap = BitmapFactory.decodeResource(
                            RegularInvoiceActivity.this.getResources(),
                            R.drawable.saas_logo);
                }
                return QRCodeEncoder.syncEncodeQRCode(util.getMobilePhone(),
                        BGAQRCodeUtil.dp2px(RegularInvoiceActivity.this, 150),
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    ...
                    Toast.makeText(RegularInvoiceActivity.this, "生成二维码失败",
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                if (TextUtils.isEmpty(result)) {
                    Toast.makeText(RegularInvoiceActivity.this, errorTip,
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(RegularInvoiceActivity.this, result,
                            Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.head_more:
                //截屏
                Bitmap b=ScreenShotUtil.takeScreenShot(RegularInvoiceActivity.this);
    ...
    public void onResponse(String response) {
        ...
        try {
            ...
            ToastUtils.showShortToastSafe(RegularInvoiceActivity.this, jsonObject.getString("ErrMsg"));
